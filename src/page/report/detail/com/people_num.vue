...
<script>
import { handleDateTypeTransform, getStaus, getChartData } from "service";
import {
  Button,
  Form,
  FormItem,
    ...
    .btns-wrapper {
      ...
      .btn {
        ...
        .arrow-icon {
          ...
          &.color-1 {
            border-color: #22b572 transparent transparent transparent;
          }
          &.color-2 {
            border-color: #f8b62d transparent transparent transparent;
          }
          &.color-3 {
            border-color: #e80f9b transparent transparent transparent;
          }
          &.color-4 {
            border-color: #e83828 transparent transparent transparent;
          }
          &.color-5 {
            border-color: #197748 transparent transparent transparent;
          }
          &.color-6 {
            border-color: #f8b62d transparent transparent transparent;
          }
          &.color-7 {
            border-color: #be136e transparent transparent transparent;
          }
          &.color-8 {
            border-color: #bc1313 transparent transparent transparent;
          }
        }
        cursor: pointer;
        width: 130px;
