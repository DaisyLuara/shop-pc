      ...
      <div 
        ...
        <div 
          ...
          <div 
            v-show="!editName"
            class="account-item" >
            <div class="account-item-title">公司名称：
              <i 
          ...
          <div 
            ...
            <el-button 
              type="primary" 
              size="mini" 
              @click="saveCompanyName">保存</el-button>
          </div>
          ...
          <div class="account-item grade">
            ...
            <span 
              class="grade_name">LV.1</span>
            <div 
              class="grade-line">
              <div 
                class="grade-line-done"/>
            </div>
            <!-- <span 
              class="grade_text" 
              @click="gradeVisible=true">等级特权</span> -->
          </div>
          <!-- <div 
            class="account-item money">
            <span>
              <img 
                :src="IMG_URL+'ad_shop/img/account_1.png?v=2'"
                class="hi_icon">
            </span>
            <span class="money-text">嗨币</span>
            <span class="money-number">1,000</span>
            <el-button 
              type="primary" 
              size="mini"
              @click="payVisible=true">充值</el-button>
          </div> -->
        </div>
      </div>
      <!-- 账号密码设置 -->
        ...
        <div class="pay-content">
          <el-tabs 
            ...
            <el-tab-pane>
              <span slot="label">支付宝 
                <img 
                  :src="IMG_URL+'ad_shop/img/alipay.png'" 
                  style="width: 20%;"></span>
              <div class="qr-code">
            ...
            <el-tab-pane>
              <span slot="label">微信 
                <img 
                  :src="IMG_URL+'ad_shop/img/wechat.png'" 
                  style="width: 20%;"></span>
              <div class="qr-code">
